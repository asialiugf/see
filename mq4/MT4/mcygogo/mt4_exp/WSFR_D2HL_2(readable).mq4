...
extern double LimitOrder = 1;   //флаг - дистанция лимитного ордера . если = 0 - откл.
...
extern double iCCI_OpenFilter = 170; //--- (100 10 400) Фильтр по iCCI для Buy и Sell. При оптимизации под JPY рекомендуемо оптить по правилу (100 50 4000)
