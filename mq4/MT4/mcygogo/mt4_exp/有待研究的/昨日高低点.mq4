...
ObjectDelete("1dayHigh");
ObjectDelete("1dayLow");

ObjectCreate("1dayHigh", OBJ_HLINE,0, CurTime(),phigh);
ObjectSet("1dayHigh",OBJPROP_COLOR,SpringGreen);
ObjectSet("1dayHigh",OBJPROP_STYLE,STYLE_SOLID);

ObjectCreate("1dayLow", OBJ_HLINE,0, CurTime(),plow);
ObjectSet("1dayLow",OBJPROP_COLOR,Red);
ObjectSet("1dayLow",OBJPROP_STYLE,STYLE_SOLID);
