...
int start()
{
	...
	*/
	...
	double iMA1  = iMA(Symbol(), 0, 21, 0, MODE_EMA, PRICE_CLOSE, 1);
	double iMA1p = iMA(Symbol(), 0, 21, 0, MODE_EMA, PRICE_CLOSE, 2);
	double iMA2  = iMA(Symbol(), 0, 34, 0, MODE_EMA, PRICE_CLOSE, 1);
	double iMA2p = iMA(Symbol(), 0, 34, 0, MODE_EMA, PRICE_CLOSE, 2);
